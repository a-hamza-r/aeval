...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int) (_FH_3 Int) (|_FH_3'| Int)) (=> (and (<= _FH_2 3000) (>= _FH_2 3000) (>= _FH_1 2000) (= |_FH_0'| (+ _FH_0 1)) (>= _FH_0 1000) (= |_FH_3'| (+ _FH_3 1)) (= |_FH_2'| (+ _FH_2 1)) (= |_FH_1'| (+ _FH_1 1)) (inv_3 _FH_0 _FH_1 _FH_2 _FH_3)) (inv_3 |_FH_0'| |_FH_1'| |_FH_2'| |_FH_3'|))))
