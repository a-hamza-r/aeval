...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int)) (=> (and (<= _FH_0 9996) (= |_FH_0'| (+ _FH_0 2)) (distinct _FH_0 9998) (inv_0 _FH_0)) (inv_0 |_FH_0'|))))

(assert (forall ((_FH_0 Int)) (=> (and (inv_0 _FH_0) (not (distinct _FH_0 9998))) (inv_1 _FH_0))))

(assert (forall ((_FH_0 Int) (|_FH_0'| Int)) (=> (and (= _FH_0 9998) (<= _FH_0 9996) (= |_FH_0'| 1) (inv_1 _FH_0)) (inv_1 |_FH_0'|))))
