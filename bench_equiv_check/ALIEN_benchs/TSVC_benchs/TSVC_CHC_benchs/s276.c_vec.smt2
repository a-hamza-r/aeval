...
(rule (=> 
	(and 
		...
		(= a_i1 (ite (< (+ i 2) mid) (+ (select a_array1 (+ i 1)) (* (select b_array (+ i 1)) (select c_array (+ i 1)))) (+ (select a_array1 (+ i 1)) (* (select b_array (+ i 1)) (select d_array (+ i 1))))))
		(= a_array2 (store a_array1 (+ i 1) a_i1))

		(= a_i2 (ite (< (+ i 3) mid) (+ (select a_array2 (+ i 2)) (* (select b_array (+ i 2)) (select c_array (+ i 2)))) (+ (select a_array2 (+ i 2)) (* (select b_array (+ i 2)) (select d_array (+ i 2))))))
		(= a_array3 (store a_array2 (+ i 2) a_i2))

		(= a_i3 (ite (< (+ i 4) mid) (+ (select a_array3 (+ i 3)) (* (select b_array (+ i 3)) (select c_array (+ i 3)))) (+ (select a_array3 (+ i 3)) (* (select b_array (+ i 3)) (select d_array (+ i 3))))))
		(= a_array4 (store a_array3 (+ i 3) a_i3))

		(= a_i4 (ite (< (+ i 5) mid) (+ (select a_array4 (+ i 4)) (* (select b_array (+ i 4)) (select c_array (+ i 4)))) (+ (select a_array4 (+ i 4)) (* (select b_array (+ i 4)) (select d_array (+ i 4))))))
		(= a_array5 (store a_array4 (+ i 4) a_i4))

		(= a_i5 (ite (< (+ i 6) mid) (+ (select a_array5 (+ i 5)) (* (select b_array (+ i 5)) (select c_array (+ i 5)))) (+ (select a_array5 (+ i 5)) (* (select b_array (+ i 5)) (select d_array (+ i 5))))))
		(= a_array6 (store a_array5 (+ i 5) a_i5))

		(= a_i6 (ite (< (+ i 7) mid) (+ (select a_array6 (+ i 6)) (* (select b_array (+ i 6)) (select c_array (+ i 6)))) (+ (select a_array6 (+ i 6)) (* (select b_array (+ i 6)) (select d_array (+ i 6))))))
		(= a_array7 (store a_array6 (+ i 6) a_i6))

		(= a_i7 (ite (< (+ i 8) mid) (+ (select a_array7 (+ i 7)) (* (select b_array (+ i 7)) (select c_array (+ i 7)))) (+ (select a_array7 (+ i 7)) (* (select b_array (+ i 7)) (select d_array (+ i 7))))))
		(= a_array8 (store a_array7 (+ i 7) a_i7))
	)
	(loop a_array8 b_array c_array d_array (+ i 8) mid count)
))
(rule (=> 
	(and 
		(loop a_array b_array c_array d_array i mid count)
