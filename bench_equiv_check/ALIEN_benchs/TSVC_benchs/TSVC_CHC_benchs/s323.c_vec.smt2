...
(rule (=> 
	(and 
		...
		(= a_i (+ (select b_array (- i 1)) (* c_i d_i)))
		...
		(= a_i1 (+ (select b_array1 i) (* c_i1 d_i1)))
		...
		(= a_i2 (+ (select b_array2 (+ i 1)) (* c_i2 d_i2)))
		...
		(= a_i3 (+ (select b_array3 (+ i 2)) (* c_i3 d_i3)))
		...
		(= a_i4 (+ (select b_array4 (+ i 3)) (* c_i4 d_i4)))
		...
		(= a_i5 (+ (select b_array5 (+ i 4)) (* c_i5 d_i5)))
		...
		(= a_i6 (+ (select b_array6 (+ i 5)) (* c_i6 d_i6)))
...
(rule (=> 
	(and 
		...
		(= a_i7 (+ (select b_array7 (+ i 6)) (* c_i7 d_i7)))
