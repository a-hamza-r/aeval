...
(declare-rel preLoop ((Array Int Int) (Array Int Int) (Array Int Int) Int Int Int ))
(declare-rel exit ())
(declare-var k Int )
(declare-var i Int )
(declare-var i1 Int )
...
(declare-var a_i_plus_k1 Int )
(declare-var a_i_plus_k2 Int )
(declare-var a_i_plus_k3 Int )
(declare-var a_i_plus_k4 Int )
(declare-var a_i_plus_k5 Int )
(declare-var a_i_plus_k6 Int )
(declare-var a_i_plus_k7 Int )
(declare-var b_i Int )
...
(rule (=> 
	...
	(preLoop a_array b_array c_array i k count)
))
(rule (=> 
	(and 
		(preLoop a_array b_array c_array i k count)
...
(rule (=> 
	(and 
		...
		(= a_i_plus_k7 (select a_array7 (+ (+ i 7) k)))
		(= a_i7 (+ a_i_plus_k7 (* b_i7 c_i7)))
		(= a_array8 (store a_array7 (+ i 7) a_i7))
	)
	(loop a_array8 b_array c_array (+ i 8) k count)
))
(rule (=> 
	(and 
		(loop a_array b_array c_array i k count)
