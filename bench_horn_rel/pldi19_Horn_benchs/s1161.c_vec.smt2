...
(rule (=> 
	(and 
		...
		(= a_i7 (ite (< c_i7 0) (select a_array7 (+ i 7)) (+ c_i7 (* d_i7 e_i7))))
		(= a_array8 (store a_array7 (+ i 7) a_i7))
		(= b_i7 (ite (< c_i7 0) (+ (select a_array7 (+ i 7)) (* d_i7 d_i7)) (select b_array7 (+ i 7))))
