...
(declare-rel preLoop ((Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) (Array Int Int) Int Int Int ))
(declare-rel exit ())
(declare-var i Int )
(declare-var i1 Int )
(declare-var i2 Int )
...
(rule (=> 
	...
	(preLoop a_array b_array c_array d_array e_array i j count)
))
(rule (=> 
	(and 
		(preLoop a_array b_array c_array d_array e_array i j count)
	...
	(loop a_array6 b_array c_array d_array e_array (+ i 3) (+ j 6) count)
))
(rule (=> 
	(and 
