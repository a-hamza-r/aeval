...
(rule (=> 
	(and 
		...
		(= b_i7 (+ (select b_array7 (+ i 7)) (* (select a_array (+ i 8)) d_i7)))
		(= b_array8 (store b_array7 (+ i 7) b_i7))
		(= a_i7 (+ (select a_array7 (+ i 7)) c_i7))
