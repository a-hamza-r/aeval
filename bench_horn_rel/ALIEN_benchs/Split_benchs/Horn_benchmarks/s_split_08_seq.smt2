...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int)) (=> (and (= |_FH_0'| (+ _FH_0 1)) (= |_FH_1'| (+ _FH_1 0)) (distinct 2702470 _FH_0) (distinct (mod _FH_0 2) 0) (inv_1 _FH_0 _FH_1)) (inv_1 |_FH_0'| |_FH_1'|))))
