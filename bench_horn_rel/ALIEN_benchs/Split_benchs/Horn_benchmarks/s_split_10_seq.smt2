...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int)) (=> (and (< _FH_0 2000) (< (div _FH_0 5) 200) (= |_FH_0'| (+ _FH_0 1)) (inv_0 _FH_0)) (inv_0 |_FH_0'|))))

(assert (forall ((_FH_0 Int)) (=> (and (inv_0 _FH_0) (not (< (div _FH_0 5) 200))) (inv_1 _FH_0))))

(assert (forall ((_FH_0 Int) (|_FH_0'| Int)) (=> (and (< _FH_0 2000) (= |_FH_0'| (+ _FH_0 5)) (>= (div _FH_0 5) 200) (inv_1 _FH_0)) (inv_1 |_FH_0'|))))
