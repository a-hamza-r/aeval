...
(declare-var e_array2 (Array Int Int) )
(declare-var e_array3 (Array Int Int) )
(declare-var e_array4 (Array Int Int) )
(declare-var e_array5 (Array Int Int) )
(declare-var e_array6 (Array Int Int) )
(declare-var e_array7 (Array Int Int) )
(declare-var e_array8 (Array Int Int) )
...
(rule (=> 
	(and 
		...
		(= e_i1 (select a_array1 (+ i 2)))
		(= e_array2 (store e_array1 (+ i 1) e_i1))
		...
		(= e_i2 (select a_array2 (+ i 3)))
		(= e_array3 (store e_array2 (+ i 2) e_i2))
		...
		(= e_i3 (select a_array3 (+ i 4)))
		(= e_array4 (store e_array3 (+ i 3) e_i3))
		...
		(= e_i4 (select a_array4 (+ i 5)))
		(= e_array5 (store e_array4 (+ i 4) e_i4))
		...
		(= e_i5 (select a_array5 (+ i 6)))
		(= e_array6 (store e_array5 (+ i 5) e_i5))
		...
		(= e_i6 (select a_array6 (+ i 7)))
		(= e_array7 (store e_array6 (+ i 6) e_i6))
		(= a_i6 (* (select b_array6 (+ i 6)) c_i6 d_i6))
		(= a_array7 (store a_array6 (+ i 6) a_i6))
		(= b_i6 (* a_i6 e_i6 d_i6))
		(= b_array7 (store b_array6 (+ i 6) b_i6))
	)
	(loop a_array7 b_array7 c_array d_array e_array7 (+ i 7) count)
))
(rule (=> 
	(and 
		...
		(= e_i7 (select a_array7 (+ i 8)))
		(= e_array8 (store e_array7 (+ i 7) e_i7))
		(= a_i7 (* (select b_array7 (+ i 7)) c_i7 d_i7))
		(= a_array8 (store a_array7 (+ i 7) a_i7))
		(= b_i7 (* a_i7 e_i7 d_i7))
		(= b_array8 (store b_array7 (+ i 7) b_i7))
	)
	(loop a_array8 b_array8 c_array d_array e_array8 (+ i 8) count)
))
(rule (=> 
	(and 
		(loop a_array b_array c_array d_array e_array i count)
