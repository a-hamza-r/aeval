...
(rule (=> 
	(and 
		...
		(= sum2 (+ sum1 a_i1))
		(= b_array2 (store b_array1 (+ i 1) sum2))

		(= a_i2 (select a_array (+ i 2)))
		(= sum3 (+ sum2 a_i2))
		(= b_array3 (store b_array2 (+ i 2) sum3))

		(= a_i3 (select a_array (+ i 3)))
		(= sum4 (+ sum3 a_i3))
		(= b_array4 (store b_array3 (+ i 3) sum4))

		(= a_i4 (select a_array (+ i 4)))
		(= sum5 (+ sum4 a_i4))
		(= b_array5 (store b_array4 (+ i 4) sum5))

		(= a_i5 (select a_array (+ i 5)))
		(= sum6 (+ sum5 a_i5))
		(= b_array6 (store b_array5 (+ i 5) sum6))

		(= a_i6 (select a_array (+ i 6)))
		(= sum7 (+ sum6 a_i6))
		(= b_array7 (store b_array6 (+ i 6) sum7))

		(= a_i7 (select a_array (+ i 7)))
		(= sum8 (+ sum7 a_i7))
		(= b_array8 (store b_array7 (+ i 7) sum8))
	)
	(loop a_array b_array8 (+ i 8) sum8 count)
))
(rule (=> 
	(and 
		(loop a_array b_array i sum count)
