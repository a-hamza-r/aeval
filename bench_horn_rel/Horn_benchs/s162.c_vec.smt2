...
(rule (=> 
	(and 
		...
		(= a_i_plus_11 (select a_array1 (+ i1 1)))
		...
		(= a_i_plus_12 (select a_array2 (+ i2 1)))
		...
		(= a_i_plus_13 (select a_array3 (+ i3 1)))
		...
		(= a_i_plus_14 (select a_array4 (+ i4 1)))
		...
		(= a_i_plus_15 (select a_array5 (+ i5 1)))
		...
		(= a_i_plus_16 (select a_array6 (+ i6 1)))
		(= a_i6 (+ a_i_plus_16 (* b_i6 c_i6)))
		(= a_array7 (store a_array6 i6 a_i6))
		(= i7 (+ i6 1))
	)
	(loop a_array7 b_array c_array i7 count)
))
(rule (=> 
	(and 
		...
		(= a_i_plus_17 (select a_array7 (+ i7 1)))
		(= a_i7 (+ a_i_plus_17 (* b_i7 c_i7)))
		(= a_array8 (store a_array7 i7 a_i7))
		(= i8 (+ i7 1))
	)
	(loop a_array8 b_array c_array i8 count)
))
(rule (=> 
	(and 
		(loop a_array b_array c_array i count)
