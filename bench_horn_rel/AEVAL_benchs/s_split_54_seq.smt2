...
(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int)) (=> (and (< _FH_0 8000) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (+ _FH_2 1)) (= |_FH_1'| (+ _FH_1 (- 1))) (inv_0 _FH_0 _FH_1 _FH_2)) (inv_0 |_FH_0'| |_FH_1'| |_FH_2'|))))

(assert (forall ((_FH_0 Int) (_FH_1 Int) (_FH_2 Int)) (=> (and (inv_0 _FH_0 _FH_1 _FH_2) (not (< _FH_0 8000))) (inv_1 _FH_0 _FH_1 _FH_2))))

(assert (forall ((_FH_0 Int) (|_FH_0'| Int) (_FH_1 Int) (|_FH_1'| Int) (_FH_2 Int) (|_FH_2'| Int)) (=> (and (>= _FH_0 8000) (= |_FH_0'| (+ _FH_0 1)) (= |_FH_2'| (+ _FH_2 (- 1))) (= |_FH_1'| (+ _FH_1 1)) (inv_1 _FH_0 _FH_1 _FH_2)) (inv_1 |_FH_0'| |_FH_1'| |_FH_2'|))))
